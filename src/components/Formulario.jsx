  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className={`${FormularioStyle.form}`}>
        ...
        <label htmlFor="categoria" className={`${FormularioStyle.label}`}>
          Categoría:
        </label>
        <select
          id="categoria"
        ...
        <label htmlFor="precio" className={`${FormularioStyle.label}`}>
          Precio COP:
        </label>
        <input
          type="number"
        ...
        <label htmlFor="imagen" className={`${FormularioStyle.label}`}>
          URL de la imagen:
        </label>
        <input
          type="url"
        ...
        <button type="submit" className={`${FormularioStyle.button}`}>
          Enviar
        </button>
      </form>
    </>
